...
contract Auction1 {
    ...
    mapping(address => uint) public returnValues;
    ...
    function bid() public payable {
        ...
        if(msg.value >= wishPrice) {
            ...
            returnValues[msg.sender] += msg.value - wishPrice;
        }
        //새로운 입찰자 정보 등록
        maxValue=price;
        bidder = msg.sender;
    ...
    function withdraw() public payable {
        uint value = returnValues[msg.sender];

        returnValues[msg.sender] = 0;
